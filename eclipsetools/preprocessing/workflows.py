...
def preprocess_with_fixed_mask(rgb_image: np.ndarray, mask_inner_radius_px: float,
    ...
    masked_image = filtering.radial_high_pass_filter(image, moon.center) * \
                   masking.annulus_mask(image.shape, moon.center, mask_inner_radius_px, mask_outer_radius_px)
    return masked_image
